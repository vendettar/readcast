...
import { loadRecommendedBatch, fetchRecommendedCandidates } from '../batch';
...
describe('loadRecommendedBatch', () => {
    ...
    it('should return allLoaded:true when pool is empty', async () => {
        vi.spyOn(sources, 'fetchAppleTopPodcastsWithLookup').mockResolvedValue([]);
    ...
    it('should handle AbortError gracefully', async () => {
        ...
        vi.spyOn(sources, 'fetchAppleTopPodcastsWithLookup').mockResolvedValue(mockPool);
...
describe('fetchRecommendedCandidates', () => {
    ...
    it('should filter podcasts by genre', async () => {
        ...
        expect(result.every(p => p.genreNames.some(g => g.toLowerCase().includes('tech')))).toBe(true);
    });
    ...
    it('should handle abort signal', async () => {
        ...
        vi.spyOn(sources, 'fetchAppleTopPodcastsWithLookup').mockRejectedValue(
